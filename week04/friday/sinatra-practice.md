...
**Note if your `subl` command doesn't work:** You can also open the directory in Atom by opening the application and navigating to `File > Open` and selecting the `sinatra_practice` dir from the drop down selector.
