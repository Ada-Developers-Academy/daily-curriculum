...
if year < 1500 # Off shoot 2
	puts "You've landed in King Arthurs court! There aren't many friendly faces around. It looks like they may think you are a practitioner of the black arts. Luckily you know that a solar eclipse occurs at #{Time.now.strftime('%I:%M:%S %p')} on #{Time.now.strftime('%a %b %d')}, #{year}"
